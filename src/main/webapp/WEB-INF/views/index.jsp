	...
	<div class="pageSize">
		...
		<div class="a-container">
			...
			<div class="a-right-container">
				<a class="a-text">오늘보다 더 나은 내일을 위해</a>
			</div>
		</div>
		<!--  
		<div class="simple-box">우리집 근처 편의시설 찾기</div>

		<div class="b-container">
			<div class="b-container-box">
				<div class="b-container-box-img1"></div>
				<div class="b-text">집 근처 헬스장 찾기</div>


			</div>
			<div class="b-container-box">
				<div class="b-container-box-img2"></div>
				<div class="b-text">집 근처 약국 찾기</div>
			</div>

			<div class="b-container-box">
				<div class="b-container-box-img3"></div>
				<div class="b-text">집 근처 병원 찾기</div>
					...
					<div class="option">
						<div>
							<form onsubmit="searchPlaces(); return false;">
								<a>키워드 : </a><input type="text" value="" id="keyword" size="20"
									style="text-align: center;">
								<button type="submit" class="d-button">검색하기</button>
							</form>
						</div>
					</div>
					<hr>
		...
		<div class="c-container">
			<div class="c-container-box">
				<a class="c-text">후원 문의 : 02-1111-2222&nbsp;&nbsp;&nbsp;</a>
				<div class="c-img"></div>
			</div>

			<div class="c-container-box">
				<a class="c-text">자원 봉사 문의 : 02-3333-4444&nbsp;&nbsp;&nbsp;</a>
